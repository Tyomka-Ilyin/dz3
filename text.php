...
for ($i==0;$i<$kol;$i++){
	if(($text[$i]==" " and $text[$i-1]==".") or ($text[$i]==" " and $text[$i-1]==",") or ($text[$i]==" " and $text[$i-1]==":") or ($text[$i]=="." and $text[$i+1]!=" ")or ($text[$i]==" " and $text[$i-1]!=="–" and $text[$i-2]!==" ") or ($text[$i]==" " and $text[$i-1]=="?") or ($text[$i]==" " and $text[$i-1]=="!") or ($text[$i]=="?" and $text[$i+1]!=" ") or ($text[$i]=="!" and $text[$i+1]!=" ")){
		$kol_sl++;
		...
		while($a>-1){
			if($text[$a]!=="." or $text[$a]!=="," or $text[$a]!==":" or $text[$a]!=="!" or $text[$a]!=="?"){
				$word.=$text[$a];
			}
			$a--;
		}
